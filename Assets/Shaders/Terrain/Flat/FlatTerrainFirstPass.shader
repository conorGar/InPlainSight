//https://github.com/pavelkouril/unity-lowpoly-shader/blob/master/README.md
//https://alastaira.wordpress.com/2013/12/07/custom-unity-terrain-material-shaders/

Shader "Custom/FlatTerrainFirstPass"
{
    Properties
    {
	...
	Dependency "AddPassShader" = "Terrain/FlatTerrainAddPass"
	Fallback "Diffuse"
}